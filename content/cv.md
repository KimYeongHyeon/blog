...
**Ph.D Student @ BiLab, Seoul National University**
...
- Developed a MAML-based segmentation model for left ventricular mass quantification from multi-view echocardiograms.
- Led research discussions with professors and doctors to define medical imaging research objectives.
...
- Contributed to six computer vision papers, including one first-author publication.
- Worked on hierarchical feature learning, open-set object detection, and active semi-supervised learning.
...
- **Adaptive thresholding for CT metal artifact reduction via LangGraph**
  Yeonghyeon Kim, Kyungsang Kim, Dongheon Lee. *Physics in Medicine & Biology*, 2026.
...
- **Quantification of left ventricular mass in multiple views of echocardiograms using model-agnostic meta learning in a few-shot setting**
  Yeong Hyeon Kim, Donghoon Kim, Jin Young Youm, Jiyoon Won, Seola Kim, Woohyun Park, Yisak Kim, Dongheon Lee. *PeerJ Computer Science*, 2025.

- **Hierarchical open-set object detection in unseen data**
  Yeong Hyeon Kim, Dong Kyun Shin, Minhaz Uddin Ahmed, Phill Kyu Rhee. *Symmetry*, 2019.

- **EER-ASSL: Combining Rollback Learning and Deep Learning for Rapid Adaptive Object Detection**
  Minhaz Uddin Ahmed, Yeong Hyeon Kim, Phill Kyu Rhee. 2020.

## Open Source

### mimic-iv-omop-pg
**PostgreSQL port of the OHDSI/MIMIC ETL**

*2026*

- Ported MIMIC-IV ETL workflows from BigQuery to PostgreSQL.
